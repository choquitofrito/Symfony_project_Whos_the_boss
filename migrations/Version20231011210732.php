 ...
 */
final class Version20231011210732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, entreprise_id INT DEFAULT NULL, commentaire VARCHAR(1000) DEFAULT NULL, date DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_8F91ABF0A76ED395 (user_id), INDEX IDX_8F91ABF0A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cotation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, entreprise_id INT NOT NULL, critere_id INT DEFAULT NULL, note INT NOT NULL, commentaire LONGTEXT DEFAULT NULL, date_cotation DATETIME DEFAULT NULL, INDEX IDX_996DA944A76ED395 (user_id), INDEX IDX_996DA944A4AEAFEA (entreprise_id), INDEX IDX_996DA9449E5F45AB (critere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cotation ADD CONSTRAINT FK_996DA9449E5F45AB FOREIGN KEY (critere_id) REFERENCES critere (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cotation DROP FOREIGN KEY FK_996DA9449E5F45AB');
