 ...
 */
final class Version20231011205127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cotation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, entreprise_id INT NOT NULL, note INT NOT NULL, commentaire LONGTEXT DEFAULT NULL, date_cotation DATETIME DEFAULT NULL, INDEX IDX_996DA944A76ED395 (user_id), INDEX IDX_996DA944A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
